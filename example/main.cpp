...
int main() {
    ...
    using BlockT = Block<4, BlockDims<4>, FloatRepr, CPUArithmetic, MaximumFractionalQuantization>;
    ...
    using IBlock = BlockFactory<BlockDims<2, 2, 2>, 2, fp8::E4M3Type, CPUArithmetic, MaximumFractionalQuantization>;
