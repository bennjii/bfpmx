...
namespace mx::vector {
    ...
    class MxVector { 
        ...
        // Default destructor - no GPU view cleanup needed
        ~MxVector() = default;

        // Simple copy constructor - just copy blocks
        MxVector(const MxVector& other) 
            : blocks_(other.blocks_), num_elements_(other.num_elements_) {}
        ...
        const std::vector<BlockType>& getBlocks() const {
            return blocks_;
        }
